...
public final class CuentaBasica extends CuentaUsuario {

	public CuentaBasica(String nombreUsuario, String email, long telefono, int edad) {
	...
	public void actualizarPerfil(String email, long telefono) {
		...
		String usuarioActualizado = Utils.formatearUsuario(getNombreUsuario(), getEmail(), getTelefono(), getEdad(), "b");
	...
	public void publicarMensaje(String mensaje) {
		...
		FicheroCuentas fc = new FicheroCuentas();
		String fMensaje = getEmail() + ";Cuenta Básica;" + f.format(fechaFormateada) + ";" + mensaje + "\n";
